...
class Ui_Dialog(object):
    ...
    def on_click_crop(self):
        ...
        if len(value_array) == 4:
            ...
            self.editor.crop(int_array[0], int_array[1], int_array[2], int_array[3])
            self.image_view.setPixmap(self.editor.img.toqpixmap())

    def on_click_save(self):
        title = str(QInputDialog.getText(None, "Input", "What is the title you want?")[0])
        if title != "":
            self.editor.save(title)
            print(title.title())
